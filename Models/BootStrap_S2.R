...
Estimate_ReMeasure_S2_Pair = function(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3, 
  ...
  nc3 = nrow(Zc3)
  nt3 = nrow(Zt3)
  out = Estimate_ReMeasure_S2(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3, 
...
Estimate_ReMeasure_S2_Res = function(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3, 
                                     Index_C, Index_T, tol.c = 1e-7, B,
                                     a0.Ini = NULL, a1.Ini = NULL, a3.Ini = NULL, 
                                     rho1.Ini = NULL, rho2.Ini = NULL, beta.Ini = NULL,
                                     sigma1.Ini = NULL, sigma2.Ini = NULL, sigma3.Ini = NULL) {
  ...
  nc3 = nrow(Zc3)
  nt3 = nrow(Zt3)
  out = Estimate_ReMeasure_S2(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3, Index_C, Index_T, tol.c)
  a0_hat = out$a0
  a0Var = out$a0Var
  a1_hat = out$a1
  a3_hat = out$a3
...
Estimate_ReMeasure_S2_Wild = function(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3, 
                                      Index_C, Index_T, tol.c = 1e-7, B,
                                      a0.Ini = NULL, a1.Ini = NULL, a3.Ini = NULL, 
                                      rho1.Ini = NULL, rho2.Ini = NULL, beta.Ini = NULL,
                                      sigma1.Ini = NULL, sigma2.Ini = NULL, sigma3.Ini = NULL) {
...
batch.ReMeasure.S2.pair = function(Y, X, Z, ind.r1, ind.r2, Y.r1, Y.r2) {
  ...
  Estimate = Estimate_ReMeasure_S2_Pair(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3,
...
batch.ReMeasure.S2.res = function(Y, X, Z, ind.r1, ind.r2, Y.r1, Y.r2) {
  ind0 <- X == 0  ## Control Group 
  ind1 <- X == 1
  Yc1 = Y[ind0]
  Yt2 = Y[ind1]
  ...
  Estimate = Estimate_ReMeasure_S2_Res(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3,
                                       ind.r1, ind.r2, tol.c = 1e-7, B = 1000)
  a0H = Estimate$a0
  a0Var = Estimate$a0Var
  a1H = Estimate$a1
...
batch.ReMeasure.S2.wild = function(Y, X, Z, ind.r1, ind.r2, Y.r1, Y.r2) {
  ind0 <- X == 0  ## Control Group 
  ind1 <- X == 1
  Yc1 = Y[ind0]
  Yt2 = Y[ind1]
  ...
  Estimate = Estimate_ReMeasure_S2_Wild(Zc1, Zt2, Zc3, Zt3, Yc1, Yt2, Yc3, Yt3,
                                        ind.r1, ind.r2, tol.c = 1e-7, B = 1000)
  a0H = Estimate$a0
  a0Var = Estimate$a0Var
  a1H = Estimate$a1
...
oneReplicate_Pair_S2 = function(seedJ){
  set.seed(seedJ + repID * 300)
  source("./oneReplicate/oneReplicate-New-S2.R")
  Estimate = batch.ReMeasure.S2.pair(Y, X, Z, ind.r1, ind.r2, Y.r1, Y.r2)
  a0H = Estimate$a0
...
oneReplicateWrap_Pair_S2 = function(seedJ) {
  eval = oneReplicate_Pair_S2(seedJ)
  return(eval)
}

oneReplicate_Res_S2 = function(seedJ) {
  set.seed(seedJ + repID * 300)
  source("./oneReplicate/oneReplicate-New-S2.R")
  Estimate = batch.ReMeasure.S2.res(Y, X, Z, ind.r1, ind.r2, Y.r1, Y.r2)
  a0H = Estimate$a0
  a0Var = Estimate$a0Var ## variance (Not from bootstrap)
  a1H = Estimate$a1
  a3H = Estimate$a3
...
oneReplicateWrap_Res_S2 = function(seedJ) {
  eval = oneReplicate_Res_S2(seedJ)
  return(eval)
}


oneReplicate_Wild_S2 = function(seedJ) {
  set.seed(seedJ + repID * 300)
  source("./oneReplicate/oneReplicate-New-S2.R")
  Estimate = batch.ReMeasure.S2.wild(Y, X, Z, ind.r1, ind.r2, Y.r1, Y.r2)
  a0H = Estimate$a0
  a0Var = Estimate$a0Var ## variance (Not from bootstrap)
  a1H = Estimate$a1
  a3H = Estimate$a3
...
oneReplicateWrap_Wild_S2 = function(seedJ) {
  eval = oneReplicate_Wild_S2(seedJ)
  return(eval)
}
