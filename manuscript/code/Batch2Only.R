...
oneReplicateWrap_OnlyBatch2_NG = function(seedJ) {
  eval = oneReplicate_OnlyBatch2_NG(seedJ)
  return(eval)
}

oneReplicate_OnlyBatch2_NG = function(seedJ) {
  set.seed(seedJ + repID * 300)
  source("./Simulation/oneReplicate-NonGaussian-S1.R")
  Estimate = batch.Batch2.S1(Y, X, Z, ind.r, Y.r)
  a0H = Estimate$a0
  a0Var = Estimate$a0Var
  a1H = Estimate$a1
